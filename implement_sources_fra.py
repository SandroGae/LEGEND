...
base_positions = {
    ...
    2: [-23.0977, 153.2694, height_1 + (absorber_height + capsule_height_up) / 2.0],
    3: [-144.2840, -56.6315, height_1 + (absorber_height + capsule_height_up) / 2.0],
    4: [23.0977, -153.2694, height_1 + (absorber_height + capsule_height_up) / 2.0]
}
